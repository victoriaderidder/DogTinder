...
error_reporting(E_ALL);
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            if(mysqli_num_rows($resultImg) > 0){
                While($rowImg = mysqli_fetch_array($resultImg)){ 
                    ...
                    echo "<img src='$target_dir/".$image."' style='max-width:400px;max-height:400px;' />";
                }
            }
    ...
    ?>
            <p><center>
                <a href="update.php" class="btn btn-primary">Update Info</a>
            </p>
            <p>
                <a href="picture.php" class="btn btn-primary">Add Photo</a>
            </p>
            <p>
